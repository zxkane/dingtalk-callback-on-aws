...
class CallbackTests : AbstractTest() {
    ...
    init {
        ...
        "check-url callback request" {
            ...
            val apiRequest = GenericMessage(EncryptedEvent(encryptedMap.get("encrypt") as String),
                MessageHeaders(
                    mapOf("request" to APIGatewayProxyRequestEvent().withQueryStringParameters(
                        mapOf(
            ...
            callback.handleRequest(apiRequest)
        }
